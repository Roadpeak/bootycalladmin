...
export default function DashboardLayout({
  ...
  return (
    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      {sidebarOpen && (
        <div
          className="fixed inset-0 bg-gradient-to-br from-red-900/30 via-black/60 to-amber-900/30 backdrop-blur-sm z-40 lg:hidden"
      ...
      <aside
        className={`
          fixed top-0 left-0 h-full w-64 bg-gradient-to-b from-red-950 via-amber-950 to-red-900 text-white z-50 transform transition-transform duration-300 ease-in-out shadow-2xl
      ...
      >
        ...
        <button
          onClick={closeSidebar}
          className="absolute top-4 right-4 lg:hidden text-red-200 hover:text-white transition-colors bg-red-900/50 rounded-lg p-1 hover:bg-red-800"
        >
          <X className="h-6 w-6" />
        </button>

        {/* Logo */}
        <div className="p-5 border-b border-amber-800/50 bg-gradient-to-r from-red-700 to-amber-800 shadow-lg">
          <h1 className="text-xl font-bold text-white">Butical Admin</h1>
          <p className="text-xs text-amber-100 mt-1">Management Dashboard</p>
        </div>
        ...
        <nav className="mt-4 overflow-y-auto h-[calc(100vh-80px)]">
          <ul className="space-y-2 px-2">
            ...
            <li className="pt-4 pb-2">
              <div className="px-4 text-xs text-amber-300 uppercase font-semibold tracking-wider border-t border-amber-800/30 pt-4">Payments</div>
            </li>
            <li>
              <Link
